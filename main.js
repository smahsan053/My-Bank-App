...
const logExistingAccount = async (newCustomer) => {
...
const loop = async (input, newCustomer) => {
...
const accountLoop = async (bankAccount, balance, userName, password, newCustomer) => {
